...
// include: /tmp/tmpqkrghd4m.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/max/Documents/Polytech/8S/Rust/ruzzle/target/wasm32-unknown-emscripten/debug/deps/ruzzle.data';
      var REMOTE_PACKAGE_BASE = 'ruzzle.data';
...
Module['FS_createPath']("/rsc", "images", true, true);
Module['FS_createPath']("/rsc", "shaders", true, true);
Module['FS_createPath']("/rsc", "sounds", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_/home/max/Documents/Polytech/8S/Rust/ruzzle/target/wasm32-unknown-emscripten/debug/deps/ruzzle.data');
      }
      Module['addRunDependency']('datafile_/home/max/Documents/Polytech/8S/Rust/ruzzle/target/wasm32-unknown-emscripten/debug/deps/ruzzle.data');
    ...
    loadPackage({"files": [{"filename": "/rsc/Crab.blend", "start": 0, "end": 387272}, {"filename": "/rsc/crab.glb", "start": 387272, "end": 694388}, {"filename": "/rsc/crab_2.glb", "start": 694388, "end": 1005988}, {"filename": "/rsc/images/back_button.png", "start": 1005988, "end": 1006333}, {"filename": "/rsc/images/background.png", "start": 1006333, "end": 1009025}, {"filename": "/rsc/images/bg_loading.png", "start": 1009025, "end": 1012785}, {"filename": "/rsc/images/bg_logo.png", "start": 1012785, "end": 1016545}, {"filename": "/rsc/images/sand.png", "start": 1016545, "end": 1016722}, {"filename": "/rsc/map.glb", "start": 1016722, "end": 1022214}, {"filename": "/rsc/shaders/cel_shade.fs", "start": 1022214, "end": 1023418}, {"filename": "/rsc/shaders/cel_shade.vs", "start": 1023418, "end": 1024043}, {"filename": "/rsc/shaders/postprocess.fs", "start": 1024043, "end": 1026443}, {"filename": "/rsc/sounds/8bit_crab_rave.mp3", "start": 1026443, "end": 2179383}, {"filename": "/rsc/sounds/boing_effect.mp3", "start": 2179383, "end": 2229617}, {"filename": "/rsc/sounds/click_effect.mp3", "start": 2229617, "end": 2251925}, {"filename": "/rsc/sounds/jump_effect.mp3", "start": 2251925, "end": 2290553}, {"filename": "/rsc/sounds/rotate_effect.mp3", "start": 2290553, "end": 2334941}, {"filename": "/rsc/sounds/walking_effect.mp3", "start": 2334941, "end": 2538589}], "remote_package_size": 2538589});

  })();

// end include: /tmp/tmpqkrghd4m.js
// include: /tmp/tmpmju3zgeg.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpmju3zgeg.js
// include: /tmp/tmp6_zgahl1.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp6_zgahl1.js
...
var ASM_CONSTS = {
  114348: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 116506: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 116670: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 116774: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 116945: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 119773: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 119839: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 120232: ($0) => { miniaudio.untrack_device_by_index($0); },  
 120275: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 120400: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; },  
 120526: () => { if (document.fullscreenElement) return 1; },  
 120572: () => { return document.getElementById('canvas').width; },  
 120624: () => { return parseInt(document.getElementById('canvas').style.width); },  
 120692: () => { document.exitFullscreen(); },  
 120719: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 120792: () => { if (document.fullscreenElement) return 1; },  
 120838: () => { return document.getElementById('canvas').width; },  
 120890: () => { return screen.width; },  
 120915: () => { document.exitFullscreen(); },  
 120942: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 121075: () => { return window.innerWidth; },  
 121101: () => { return window.innerHeight; },  
 121128: () => { if (document.fullscreenElement) return 1; },  
 121174: () => { return document.getElementById('canvas').width; },  
 121226: () => { return parseInt(document.getElementById('canvas').style.width); },  
 121294: () => { if (document.fullscreenElement) return 1; },  
 121340: () => { return document.getElementById('canvas').width; },  
 121392: () => { return screen.width; },  
 121417: () => { return window.innerWidth; },  
 121443: () => { return window.innerHeight; },  
 121470: () => { if (document.fullscreenElement) return 1; },  
 121516: () => { return document.getElementById('canvas').width; },  
 121568: () => { return screen.width; },  
 121593: () => { document.exitFullscreen(); },  
 121620: () => { if (document.fullscreenElement) return 1; },  
 121666: () => { return document.getElementById('canvas').width; },  
 121718: () => { return parseInt(document.getElementById('canvas').style.width); },  
 121786: () => { document.exitFullscreen(); },  
 121813: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 121871: () => { return screen.width; },  
 121896: () => { return screen.height; },  
 121922: () => { return window.screenX; },  
 121949: () => { return window.screenY; },  
 121976: () => { return window.devicePixelRatio; },  
 122012: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 122065: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 122136: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 122193: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 122449: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 122520: () => { if (document.fullscreenElement) return 1; },  
 122566: () => { return window.innerWidth; },  
 122592: () => { return window.innerHeight; },  
 122619: () => { if (document.pointerLockElement) return 1; }
};

// Imports from the Wasm binary.
var _main = Module['_main'] = makeInvalidEarlyAccess('_main');
var _custom_trace_log_callback = Module['_custom_trace_log_callback'] = makeInvalidEarlyAccess('_custom_trace_log_callback');
var _callback_0 = Module['_callback_0'] = makeInvalidEarlyAccess('_callback_0');
var _callback_1 = Module['_callback_1'] = makeInvalidEarlyAccess('_callback_1');
var _callback_2 = Module['_callback_2'] = makeInvalidEarlyAccess('_callback_2');
var _callback_3 = Module['_callback_3'] = makeInvalidEarlyAccess('_callback_3');
var _callback_4 = Module['_callback_4'] = makeInvalidEarlyAccess('_callback_4');
var _callback_5 = Module['_callback_5'] = makeInvalidEarlyAccess('_callback_5');
var _callback_6 = Module['_callback_6'] = makeInvalidEarlyAccess('_callback_6');
var _callback_7 = Module['_callback_7'] = makeInvalidEarlyAccess('_callback_7');
var _callback_8 = Module['_callback_8'] = makeInvalidEarlyAccess('_callback_8');
var _callback_9 = Module['_callback_9'] = makeInvalidEarlyAccess('_callback_9');
var _callback_10 = Module['_callback_10'] = makeInvalidEarlyAccess('_callback_10');
var _callback_11 = Module['_callback_11'] = makeInvalidEarlyAccess('_callback_11');
var _callback_12 = Module['_callback_12'] = makeInvalidEarlyAccess('_callback_12');
var _callback_13 = Module['_callback_13'] = makeInvalidEarlyAccess('_callback_13');
var _callback_14 = Module['_callback_14'] = makeInvalidEarlyAccess('_callback_14');
var _callback_15 = Module['_callback_15'] = makeInvalidEarlyAccess('_callback_15');
var _callback_16 = Module['_callback_16'] = makeInvalidEarlyAccess('_callback_16');
var _callback_17 = Module['_callback_17'] = makeInvalidEarlyAccess('_callback_17');
var _callback_18 = Module['_callback_18'] = makeInvalidEarlyAccess('_callback_18');
var _callback_19 = Module['_callback_19'] = makeInvalidEarlyAccess('_callback_19');
var _callback_20 = Module['_callback_20'] = makeInvalidEarlyAccess('_callback_20');
var _callback_21 = Module['_callback_21'] = makeInvalidEarlyAccess('_callback_21');
var _callback_22 = Module['_callback_22'] = makeInvalidEarlyAccess('_callback_22');
var _callback_23 = Module['_callback_23'] = makeInvalidEarlyAccess('_callback_23');
var _callback_24 = Module['_callback_24'] = makeInvalidEarlyAccess('_callback_24');
var _callback_25 = Module['_callback_25'] = makeInvalidEarlyAccess('_callback_25');
var _callback_26 = Module['_callback_26'] = makeInvalidEarlyAccess('_callback_26');
var _callback_27 = Module['_callback_27'] = makeInvalidEarlyAccess('_callback_27');
var _callback_28 = Module['_callback_28'] = makeInvalidEarlyAccess('_callback_28');
var _callback_29 = Module['_callback_29'] = makeInvalidEarlyAccess('_callback_29');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['custom_trace_log_callback'] != 'undefined', 'missing Wasm export: custom_trace_log_callback');
  assert(typeof wasmExports['callback_0'] != 'undefined', 'missing Wasm export: callback_0');
  assert(typeof wasmExports['callback_1'] != 'undefined', 'missing Wasm export: callback_1');
  assert(typeof wasmExports['callback_2'] != 'undefined', 'missing Wasm export: callback_2');
  assert(typeof wasmExports['callback_3'] != 'undefined', 'missing Wasm export: callback_3');
  assert(typeof wasmExports['callback_4'] != 'undefined', 'missing Wasm export: callback_4');
  assert(typeof wasmExports['callback_5'] != 'undefined', 'missing Wasm export: callback_5');
  assert(typeof wasmExports['callback_6'] != 'undefined', 'missing Wasm export: callback_6');
  assert(typeof wasmExports['callback_7'] != 'undefined', 'missing Wasm export: callback_7');
  assert(typeof wasmExports['callback_8'] != 'undefined', 'missing Wasm export: callback_8');
  assert(typeof wasmExports['callback_9'] != 'undefined', 'missing Wasm export: callback_9');
  assert(typeof wasmExports['callback_10'] != 'undefined', 'missing Wasm export: callback_10');
  assert(typeof wasmExports['callback_11'] != 'undefined', 'missing Wasm export: callback_11');
  assert(typeof wasmExports['callback_12'] != 'undefined', 'missing Wasm export: callback_12');
  assert(typeof wasmExports['callback_13'] != 'undefined', 'missing Wasm export: callback_13');
  assert(typeof wasmExports['callback_14'] != 'undefined', 'missing Wasm export: callback_14');
  assert(typeof wasmExports['callback_15'] != 'undefined', 'missing Wasm export: callback_15');
  assert(typeof wasmExports['callback_16'] != 'undefined', 'missing Wasm export: callback_16');
  assert(typeof wasmExports['callback_17'] != 'undefined', 'missing Wasm export: callback_17');
  assert(typeof wasmExports['callback_18'] != 'undefined', 'missing Wasm export: callback_18');
  assert(typeof wasmExports['callback_19'] != 'undefined', 'missing Wasm export: callback_19');
  assert(typeof wasmExports['callback_20'] != 'undefined', 'missing Wasm export: callback_20');
  assert(typeof wasmExports['callback_21'] != 'undefined', 'missing Wasm export: callback_21');
  assert(typeof wasmExports['callback_22'] != 'undefined', 'missing Wasm export: callback_22');
  assert(typeof wasmExports['callback_23'] != 'undefined', 'missing Wasm export: callback_23');
  assert(typeof wasmExports['callback_24'] != 'undefined', 'missing Wasm export: callback_24');
  assert(typeof wasmExports['callback_25'] != 'undefined', 'missing Wasm export: callback_25');
  assert(typeof wasmExports['callback_26'] != 'undefined', 'missing Wasm export: callback_26');
  assert(typeof wasmExports['callback_27'] != 'undefined', 'missing Wasm export: callback_27');
  assert(typeof wasmExports['callback_28'] != 'undefined', 'missing Wasm export: callback_28');
  assert(typeof wasmExports['callback_29'] != 'undefined', 'missing Wasm export: callback_29');
  ...
  _custom_trace_log_callback = Module['_custom_trace_log_callback'] = createExportWrapper('custom_trace_log_callback', 2);
  _callback_0 = Module['_callback_0'] = createExportWrapper('callback_0', 2);
  _callback_1 = Module['_callback_1'] = createExportWrapper('callback_1', 2);
  _callback_2 = Module['_callback_2'] = createExportWrapper('callback_2', 2);
  _callback_3 = Module['_callback_3'] = createExportWrapper('callback_3', 2);
  _callback_4 = Module['_callback_4'] = createExportWrapper('callback_4', 2);
  _callback_5 = Module['_callback_5'] = createExportWrapper('callback_5', 2);
  _callback_6 = Module['_callback_6'] = createExportWrapper('callback_6', 2);
  _callback_7 = Module['_callback_7'] = createExportWrapper('callback_7', 2);
  _callback_8 = Module['_callback_8'] = createExportWrapper('callback_8', 2);
  _callback_9 = Module['_callback_9'] = createExportWrapper('callback_9', 2);
  _callback_10 = Module['_callback_10'] = createExportWrapper('callback_10', 2);
  _callback_11 = Module['_callback_11'] = createExportWrapper('callback_11', 2);
  _callback_12 = Module['_callback_12'] = createExportWrapper('callback_12', 2);
  _callback_13 = Module['_callback_13'] = createExportWrapper('callback_13', 2);
  _callback_14 = Module['_callback_14'] = createExportWrapper('callback_14', 2);
  _callback_15 = Module['_callback_15'] = createExportWrapper('callback_15', 2);
  _callback_16 = Module['_callback_16'] = createExportWrapper('callback_16', 2);
  _callback_17 = Module['_callback_17'] = createExportWrapper('callback_17', 2);
  _callback_18 = Module['_callback_18'] = createExportWrapper('callback_18', 2);
  _callback_19 = Module['_callback_19'] = createExportWrapper('callback_19', 2);
  _callback_20 = Module['_callback_20'] = createExportWrapper('callback_20', 2);
  _callback_21 = Module['_callback_21'] = createExportWrapper('callback_21', 2);
  _callback_22 = Module['_callback_22'] = createExportWrapper('callback_22', 2);
  _callback_23 = Module['_callback_23'] = createExportWrapper('callback_23', 2);
  _callback_24 = Module['_callback_24'] = createExportWrapper('callback_24', 2);
  _callback_25 = Module['_callback_25'] = createExportWrapper('callback_25', 2);
  _callback_26 = Module['_callback_26'] = createExportWrapper('callback_26', 2);
  _callback_27 = Module['_callback_27'] = createExportWrapper('callback_27', 2);
  _callback_28 = Module['_callback_28'] = createExportWrapper('callback_28', 2);
  _callback_29 = Module['_callback_29'] = createExportWrapper('callback_29', 2);
